...
public class IUTextual {
    ...
    public void listarAulas() {
        ...
        String[] aulasRepresentadas = modelo.representarAulas();
        if (aulasRepresentadas.length == 0) {
            System.out.println(ERROR + "No hay aulas.");
        }
        for (int i = 0; i < aulasRepresentadas.length && aulasRepresentadas[i] != null; i++) {
            System.out.println(aulasRepresentadas[i]);
        }
    }
    ...
    public void listarProfesores() {
        ...
        String[] profesoresRepresentados = modelo.representarProfesores();
        if (profesoresRepresentados.length == 0) {
            System.out.println(ERROR + "No hay prefesores.");
        }
        for (int i = 0; i < profesoresRepresentados.length && profesoresRepresentados[i] != null; i++) {
            System.out.println(profesoresRepresentados[i]);
        }
    }
    ...
    public void listarReservas() {
        ...
        String[] reservasRepresentadas = modelo.representarReservas();
        if (reservasRepresentadas.length == 0) {
            System.out.println("No hay reservas.");
        }
        for (int i = 0; i < reservasRepresentadas.length && reservasRepresentadas[i] != null; i++) {
            System.out.println(reservasRepresentadas[i]);
        }
    }
    ...
    public void listarReservasAula() throws OperationNotSupportedException {
        ...
        Reserva[] reservasRepresentadas = modelo.getReservasAula(aula);
        if (existeAula && reservasRepresentadas[0] == null) {
    ...
    public void listarReservasProfesor() throws OperationNotSupportedException {
        ...
        Reserva[] reservasRepresentadas = modelo.getReservasProfesor(profesor);
        if (existeProfesor && reservasRepresentadas[0] == null) {
    ...
    public void listarReservasPermanencia() {
        ...
        Tramo tramo = Consola.leerTramo();
        Permanencia permanencia = new Permanencia(dia, tramo);
        Reserva[] reservasRepresentadas = modelo.getReservasPermanencia(permanencia);
        if (reservasRepresentadas[0] == null) {
